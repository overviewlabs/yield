...
const EMPTY_ENTITLEMENTS:Entitlements=Object.freeze({stockTrading:false,optionsTrading:false,multiLegOptions:false,maximumActiveAgents:0,automaticMode:false,monitoringFrequencyMinutes:0,advancedAnalytics:false,customWatchlists:false,scannerAccess:false,agentCatalog:[],prioritySupport:false});
