...
module "platform" {
  ...
  execution_desired_count                = 1
  market_data_desired_count              = var.market_data_desired_count
  broker_sync_desired_count              = var.broker_sync_desired_count
  broker_snapshot_max_age_seconds        = var.broker_snapshot_max_age_seconds
  broker_sync_interval_seconds           = var.broker_sync_interval_seconds
  ...
  tags                                   = { CostCenter = "treasury-paper" }
}
